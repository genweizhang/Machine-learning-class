...
# my implementation
from team_bot import Team_Bot
from LogStateBot import LogStateBot
from SARSA_Bot import SARSA_Bot
...
def mainGame(movementInfo):
    # added by me
    global maxScore, gamesPlayed, FPS
    ...
    while True:
        ...
        if crashTest[0]:
            ...
            # see if score is greater than max
            if score > maxScore:
                maxScore = score

            # write to file
            writeScoreFile = open('max_score.txt', 'a')
            writeScoreFile.write(str(gamesPlayed) + ", " + str(score) + ", " + str(maxScore) + '\n')
